...
static config_setting_t *xspd_settings_get_option(const xspdSettings *settings, int num_fields, va_list ap, int type, int replace);
...
int __xspd_settings_getval(const xspdSettings *settings, char **value, int num_fields, ...) {
...
int __xspd_settings_getval_int(const xspdSettings *settings, int *value, int num_fields, ...) {
	const config_setting_t *setting;
	char data[1024];
	va_list ap;
	int i;
...
int __xspd_settings_getval_bool(const xspdSettings *settings, int *value, int num_fields, ...) {
	const config_setting_t *setting;
	char data[1024];
	va_list ap;
	int i;
...
int __xspd_settings_getval_list(const xspdSettings *settings, char ***value, int *count, int num_fields, ...) {
	const config_setting_t *setting;
	int i, n;
	char **retval;
	char data[1024];
...
int __xspd_settings_getval_range(const xspdSettings *settings, int *min, int *max, int num_fields, ...) {
	const config_setting_t *setting;
	int i, n;
	char **retval;
	char data[1024];
...
int __xspd_settings_getval_group(const xspdSettings *settings, xspdSettings **ret_settings, int num_fields, ...) {
	...
	*ret_settings = xspd_settings_alloc();
	if (!*ret_settings) {
		goto error_exit;
	}
...
int __xspd_settings_setval(xspdSettings *settings, const char *value, int num_fields, ...) {
	config_setting_t *setting;
	va_list ap;

	va_start(ap, num_fields);

	setting = xspd_settings_get_option(settings, num_fields, ap, CONFIG_TYPE_STRING, 0);
	if (!setting) {
...
int __xspd_settings_setval_int(xspdSettings *settings, int value, int num_fields, ...) {
	config_setting_t *setting;
	va_list ap;

	va_start(ap, num_fields);

	setting = xspd_settings_get_option(settings, num_fields, ap, CONFIG_TYPE_INT, 0);
	if (!setting)
		goto error_exit;
...
int __xspd_settings_setval_bool(xspdSettings *settings, int value, int num_fields, ...) {
	config_setting_t *setting;
	va_list ap;

	va_start(ap, num_fields);

	setting = xspd_settings_get_option(settings, num_fields, ap, CONFIG_TYPE_BOOL, 0);
	if (!setting)
		goto error_exit;
...
int __xspd_settings_setval_list(xspdSettings *settings, char * const *values, int count, int num_fields, ...) {
	config_setting_t *setting;
	...
	group = xspd_settings_get_option(settings, num_fields, ap, CONFIG_TYPE_ARRAY, 0);
	if (!group)
		goto error_exit;
...
int __xspd_settings_setval_range(xspdSettings *settings, int min, int max, int num_fields, ...) {
	config_setting_t *setting;
	...
	range = xspd_settings_get_option(settings, num_fields, ap, CONFIG_TYPE_RANGE, 1);
	if (!range)
		goto error_exit;
...
xspdSettings *xspd_settings_alloc() {
	...
	settings = malloc(sizeof(xspdSettings));
	if (!settings)
		goto error_exit;
...
xspdSettings *xspd_settings_merge(const xspdSettings *settings1, const xspdSettings *settings2) {
	...
	ret_settings = xspd_settings_duplicate(settings1);
	if (!ret_settings)
		goto error_exit;
...
inline int xspd_settings_set_list_2(xspdSettings *settings, const char *section, const char *setting, char * const *values, int num_values) {
	return __xspd_settings_setval_list(settings, values, num_values, 2, section, setting);
}

inline int xspd_settings_set_range_2(xspdSettings *settings, const char *section, const char *setting, int min, int max) {
	return __xspd_settings_setval_range(settings, min, max, 2, section, setting);
}
...
inline int xspd_settings_get_3(const xspdSettings *settings, const char *section1, const char *section2, const char *setting, char **value) {
	return __xspd_settings_getval(settings, value, 3, section1, section2, setting);
}
...
inline int xspd_settings_get_int_3(const xspdSettings *settings, const char *section1, const char *section2, const char *setting, int *value) {
	return __xspd_settings_getval_int(settings, value, 3, section1, section2, setting);
}
...
inline int xspd_settings_get_bool_3(const xspdSettings *settings, const char *section1, const char *section2, const char *setting, int *value) {
	return __xspd_settings_getval_bool(settings, value, 3, section1, section2, setting);
}

inline int xspd_settings_get_list_3(const xspdSettings *settings, const char *section1, const char *section2, const char *setting, char ***values, int *count) {
	return __xspd_settings_getval_list(settings, values, count, 3, section1, section2, setting);
}
...
inline int xspd_settings_get_range_3(const xspdSettings *settings, const char *section1, const char *section2, const char *setting, int *min, int *max) {
	return __xspd_settings_getval_range(settings, min, max, 3, section1, section2, setting);
}
...
inline int xspd_settings_get_group_3(const xspdSettings *settings, const char *section1, const char *section2, const char *setting, xspdSettings **value) {
	return __xspd_settings_getval_group(settings, value, 3, section1, section2, setting);
}
...
inline int xspd_settings_set_3(xspdSettings *settings, const char *section1, const char *section2, const char *setting, const char *value) {
	return __xspd_settings_setval(settings, value, 3, section1, section2, setting);
}
...
inline int xspd_settings_set_int_3(xspdSettings *settings, const char *section1, const char *section2, const char *setting, int value) {
	return __xspd_settings_setval_int(settings, value, 3, section1, section2, setting);
}
...
inline int xspd_settings_set_bool_3(xspdSettings *settings, const char *section1, const char *section2, const char *setting, int value) {
	return __xspd_settings_setval_bool(settings, value, 3, section1, section2, setting);
}
...
inline int xspd_settings_set_list_3(xspdSettings *settings, const char *section1, const char *section2, const char *setting, char * const *values, int num_values) {
	return __xspd_settings_setval_list(settings, values, num_values, 3, section1, section2, setting);
}
...
inline int xspd_settings_set_range_3(xspdSettings *settings, const char *section1, const char *section2, const char *setting, int min, int max) {
	return __xspd_settings_setval_range(settings, min, max, 3, section1, section2, setting);
}
...
inline int xspd_settings_get_4(const xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, char **value) {
	return __xspd_settings_getval(settings, value, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_get_int_4(const xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, int *value) {
	return __xspd_settings_getval_int(settings, value, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_get_bool_4(const xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, int *value) {
	return __xspd_settings_getval_bool(settings, value, 4, section1, section2, section3, setting);
}

inline int xspd_settings_get_list_4(const xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, char ***values, int *count) {
	return __xspd_settings_getval_list(settings, values, count, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_get_range_4(const xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, int *min, int *max) {
	return __xspd_settings_getval_range(settings, min, max, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_get_group_4(const xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, xspdSettings **value) {
	return __xspd_settings_getval_group(settings, value, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_set_4(xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, const char *value) {
	return __xspd_settings_setval(settings, value, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_set_int_4(xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, int value) {
	return __xspd_settings_setval_int(settings, value, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_set_bool_4(xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, int value) {
	return __xspd_settings_setval_bool(settings, value, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_set_list_4(xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, char * const *values, int num_values) {
	return __xspd_settings_setval_list(settings, values, num_values, 4, section1, section2, section3, setting);
}
...
inline int xspd_settings_set_range_4(xspdSettings *settings, const char *section1, const char *section2, const char *section3, const char *setting, int min, int max) {
	return __xspd_settings_setval_range(settings, min, max, 4, section1, section2, section3, setting);
}
