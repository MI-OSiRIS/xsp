...
// =============================================================================
/*
 * $Id: radix.c,v 1.2 2004/10/13 04:35:01 swany Exp $
 * $Imported: radix.c,v 1.1 2003/06/11 03:14:45 swany Exp $
 * from MRT
 */
...
{
    radix_tree_t *radix = (radix_tree_t *) malloc(sizeof(radix_tree_t));
...
void
radix_process (radix_tree_t *radix, void_fn2_t func)
{
    radix_node_t *node;
    assert (func);
...
radix_lookup (radix_tree_t *radix, prefix_t *prefix)
{
    ...
    new_node = (radix_node_t *) malloc(sizeof(radix_node_t));
	...
	fprintf (stderr, "radix_lookup: new_node #3 %s/%d (parent)\n", 
        ...
        glue = (radix_node_t *) malloc(sizeof(radix_node_t));
        glue->bit = differ_bit;
        glue->prefix = NULL;
