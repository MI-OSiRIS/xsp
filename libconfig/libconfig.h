...
extern int config_setting_delete_child(config_setting_t *parent, const char *name);
extern config_setting_t *config_setting_remove_child(config_setting_t *parent, const char *name);
extern config_setting_t *config_setting_remove_index(config_setting_t *parent, int index);
...
extern int config_setting_destroy(config_setting_t *setting);
