...
/**
 * Set parameters for histogram of calculated gap.
 * Bin sizes are given in terms of gap (nanoseconds / value)
 *
...
/**
 * Calculate histogram of calculated gap (ns/value).
 *
 ...
 *
 * \param S Calipers
 * \param V double-precision FP value
 * \return None
 */
