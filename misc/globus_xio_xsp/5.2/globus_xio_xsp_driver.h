...
typedef enum globus_xio_xsp_cntl_e
{
    ...
    GLOBUS_XIO_XSP_CNTL_SET_NL_BINS,
    GLOBUS_XIO_XSP_CNTL_SET_INTERVAL,
    GLOBUS_XIO_XSP_CNTL_SET_DPID,
    GLOBUS_XIO_XSP_CNTL_SET_DURATION,
    GLOBUS_XIO_XSP_CNTL_SET_BANDWIDTH,
    GLOBUS_XIO_XSP_CNTL_SET_SVLAN,
    GLOBUS_XIO_XSP_CNTL_SET_DVLAN,
